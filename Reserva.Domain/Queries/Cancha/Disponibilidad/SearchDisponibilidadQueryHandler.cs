...
namespace Reserva.Domain.Queries.Cancha.Disponibilidad
{
    public class SearchDisponibilidadQueryHandler : SearchQueryHandlerBase<SearchDisponibilidadQuery, SearchDisponibilidadFilterDto, SearchDisponibilidadDto>
    {
        ...
        protected override async Task<ResponseDto<SearchResultDto<SearchDisponibilidadDto>>> HandleQuery(SearchDisponibilidadQuery request, CancellationToken cancellationToken)
        {
            ...
            */
            ...
            var DisponibilidadDtos = _mapper?.Map<IEnumerable<SearchDisponibilidadDto>>(Disponibilidads.Items);

            var searchResult = new SearchResultDto<SearchDisponibilidadDto>(
                DisponibilidadDtos ?? new List<SearchDisponibilidadDto>(),
