...
{
    public class SearchGananciaProveedorQueryHandler : SearchQueryHandlerBase<SearchGananciaProveedorQuery, SearchGananciaProveedorFilterDto, SearchGananciaProveedorDto>
    {
        private readonly IRepository<Entity.Models.GananciaProveedor> _GananciaProveedorRepository;

        public SearchGananciaProveedorQueryHandler(
            IMapper mapper,
        ...
        protected override async Task<ResponseDto<SearchResultDto<SearchGananciaProveedorDto>>> HandleQuery(SearchGananciaProveedorQuery request, CancellationToken cancellationToken)
        {
            var response = new ResponseDto<SearchResultDto<SearchGananciaProveedorDto>>();
            ...
            */
            ...
            var GananciaProveedorDtos = _mapper?.Map<IEnumerable<SearchGananciaProveedorDto>>(GananciaProveedors.Items);

            var searchResult = new SearchResultDto<SearchGananciaProveedorDto>(
                GananciaProveedorDtos ?? new List<SearchGananciaProveedorDto>(),
