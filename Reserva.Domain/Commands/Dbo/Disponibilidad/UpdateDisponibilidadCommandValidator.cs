...
namespace Reserva.Domain.Commands.Dbo.Disponibilidad
{
    public class UpdateDisponibilidadCommandValidator : CommandValidatorBase<UpdateDisponibilidadCommand>
    {
        ...
        public UpdateDisponibilidadCommandValidator(IRepository<Entity.Disponibilidad> repositoryBase)
        {
            ...
            {
                RequiredField(x => x.UpdateDto.IdDisponibilidad, Resources.Dbo.Disponibilidad.IdDisponibilidad)
                    .DependentRules(() =>
                    {
                ...
                //RequiredString(x => x.UpdateDto.Codigo, Resources.Dbo.Disponibilidad.Codigo, 5, 10);
                //RequiredField(x => x.UpdateDto.FechaIngreso, Resources.Dbo.Disponibilidad.FechaIngreso);
            });
        }
