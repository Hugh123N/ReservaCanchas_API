...
namespace Reserva.Domain.Commands.Dbo.TipoProveedor
{
    public class UpdateTipoProveedorCommandValidator : CommandValidatorBase<UpdateTipoProveedorCommand>
    {
        ...
        public UpdateTipoProveedorCommandValidator(IRepository<Entity.TipoProveedor> repositoryBase)
        {
            _repositoryBase = repositoryBase;

            RequiredInformation(x => x.UpdateDto).DependentRules(() =>
            {
                RequiredField(x => x.UpdateDto.IdTipoProveedor, Resources.Dbo.TipoProveedor.IdTipoProveedor)
                    .DependentRules(() =>
                    {
                ...
                //RequiredString(x => x.UpdateDto.Codigo, Resources.Dbo.TipoProveedor.Codigo, 5, 10);
                //RequiredField(x => x.UpdateDto.FechaIngreso, Resources.Dbo.TipoProveedor.FechaIngreso);
            });
        }
