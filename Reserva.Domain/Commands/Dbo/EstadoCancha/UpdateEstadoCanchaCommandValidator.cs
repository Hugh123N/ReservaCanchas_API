...
namespace Reserva.Domain.Commands.Dbo.EstadoCancha
{
    public class UpdateEstadoCanchaCommandValidator : CommandValidatorBase<UpdateEstadoCanchaCommand>
    {
        ...
        public UpdateEstadoCanchaCommandValidator(IRepository<Entity.EstadoCancha> repositoryBase)
        {
            _repositoryBase = repositoryBase;

            RequiredInformation(x => x.UpdateDto).DependentRules(() =>
            {
                RequiredField(x => x.UpdateDto.IdEstadoCancha, Resources.Dbo.EstadoCancha.IdEstadoCancha)
                    .DependentRules(() =>
                    {
                ...
                //RequiredString(x => x.UpdateDto.Codigo, Resources.Dbo.EstadoCancha.Codigo, 5, 10);
                //RequiredField(x => x.UpdateDto.FechaIngreso, Resources.Dbo.EstadoCancha.FechaIngreso);
            });
        }
