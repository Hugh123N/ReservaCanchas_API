...
namespace Reserva.Domain.Commands.Dbo.Proveedor
{
    public class UpdateProveedorCommandValidator : CommandValidatorBase<UpdateProveedorCommand>
    {
        ...
        public UpdateProveedorCommandValidator(IRepository<Entity.Proveedor> repositoryBase)
        {
            ...
            {
                RequiredField(x => x.UpdateDto.IdProveedor, Resources.Dbo.Proveedor.IdProveedor)
                    .DependentRules(() =>
                    {
                ...
                //RequiredString(x => x.UpdateDto.Codigo, Resources.Dbo.Proveedor.Codigo, 5, 10);
                //RequiredField(x => x.UpdateDto.FechaIngreso, Resources.Dbo.Proveedor.FechaIngreso);
            });
        }
